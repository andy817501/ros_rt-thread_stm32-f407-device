...
#define PKG_USING_FIRE_PID_CURVE
#define PKG_USING_FIRE_PID_CURVE_LATEST_VERSION
...
#define RT_USING_PULSE_ENCODER3
#define RT_USING_PULSE_ENCODER4
#define RT_USING_PULSE_ENCODER5
